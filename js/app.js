/* =====================================================================
 * ⚠️ 已弃用 / DEPRECATED — 本文件目前未被 index.html 加载，不代表线上行为
 * =====================================================================
 * PET Kids 项目的实际运行逻辑已全部内联在 index.html 的 <script> 标签中
 * （包含收藏、听力拼写、称号系统、音效反馈、Toast 提示等全部最新功能）。
 * 本文件为早期版本的独立逻辑草稿，仅供历史参考，请勿在此基础上开发。
 * 如需修改应用行为，请直接编辑 index.html。
 * ===================================================================== */

/* =====================================================================
 * PET Kids 40天计划 - 核心应用逻辑 (app.js) [早期草稿版本，已弃用]
